...
[![Engine tests](https://img.shields.io/badge/engine%20tests-325%20passing-3fb950?style=flat-square)](docs/STATUS.md)
...
> the whole editing engine, including its 325-test suite, runs without launching Minecraft.
...
| | |
|---|---|
| Engine tests | **325 passing, 0 failing** (`./gradlew :core:selfTest`) |
