...
[![Engine tests](https://img.shields.io/badge/engine%20tests-510%20passing-3fb950?style=flat-square)](docs/STATUS.md)
...
> the whole editing engine, including its 510-test suite, runs without launching Minecraft.
...
| | |
|---|---|
| Engine tests | **510 passing, 0 failing** (`./gradlew :core:selfTest`) |
