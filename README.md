...
[![Engine tests](https://img.shields.io/badge/engine%20tests-471%20passing-3fb950?style=flat-square)](docs/STATUS.md)
...
> the whole editing engine, including its 471-test suite, runs without launching Minecraft.
...
| | |
|---|---|
| Engine tests | **471 passing, 0 failing** (`./gradlew :core:selfTest`) |
