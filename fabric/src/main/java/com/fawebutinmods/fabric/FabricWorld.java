...
import com.fawebutinmods.core.world.PackedBlockArray;
...
public final class FabricWorld implements World {
    ...
    public int getHighestBlockY(int x, int z) {
        ...
        if (y < minY() || com.fawebutinmods.core.world.BlockState.registry()
    ...
    @Override
    public List<EntityData> getEntities(com.fawebutinmods.core.world.Extent.Region3i box) {
    ...
    @Override
    public BlockVector3 getTargetBlock(com.fawebutinmods.core.actor.Actor actor, int maxDistance) {
