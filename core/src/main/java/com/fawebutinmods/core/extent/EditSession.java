package com.fawebutinmods.core.extent;

import com.fawebutinmods.core.history.ChangeSet;
...
import com.fawebutinmods.core.world.ChunkSet;
...
public final class EditSession implements Extent {
    ...
    @Override
    public List<com.fawebutinmods.core.world.EntityData> getEntities(Extent.Region3i box) {
        return world.getEntities(box);
    }

    @Override
    public void addEntity(com.fawebutinmods.core.world.EntityData data) {
        world.addEntity(data);
    }

    @Override
    public void removeEntity(com.fawebutinmods.core.world.EntityData data) {
        world.removeEntity(data);
    }

    public void setBlockEntity(int x, int y, int z, com.fawebutinmods.core.util.NbtCompound nbt) {
