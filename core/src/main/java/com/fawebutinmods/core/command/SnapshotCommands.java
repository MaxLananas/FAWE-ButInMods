...
import com.fawebutinmods.core.history.Snapshots;
...
final class SnapshotCommands {
    ...
    private void select() {
        ...
        entry.handler = ctx -> {
            ...
            selector.selectPrimary(new com.fawebutinmods.core.math.BlockVector3(box.minX(), box.minY(), box.minZ()),
                    com.fawebutinmods.core.region.SelectorLimits.unlimited());
            selector.selectSecondary(new com.fawebutinmods.core.math.BlockVector3(box.maxX(), box.maxY(), box.maxZ()),
                    com.fawebutinmods.core.region.SelectorLimits.unlimited());
    ...
    private static com.fawebutinmods.core.util.NbtCompound read(Ctx ctx, Path path) {
        try {
