...
import com.fawebutinmods.core.pattern.MapColors;
...
public final class Parsers {
    ...
    public static Region region(Ctx ctx, String shape, BlockVector3 center, double radius) {
        com.fawebutinmods.core.region.RegionFactory factory =
                com.fawebutinmods.core.region.RegionFactories.parse(shape, ctx.world().minY(), ctx.world().maxY());
        if (factory == null) {
