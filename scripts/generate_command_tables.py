...
Outputs (core/src/main/java/com/fawebutinmods/core/command/):
...
DOCS = ROOT / "docs"
COMMAND_DIR = ROOT / "core/src/main/java/com/fawebutinmods/core/command"
...
def main() -> None:
    ...
    for command in spec["commands"]:
        if command["status"] not in ("implemented", "alias"):
            continue
