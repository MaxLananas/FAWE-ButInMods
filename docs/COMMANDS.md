...
| `/brush ex` | — | Brush: extinguish | alias |
...
| `/tool mask <[mask]>` | — | Set the brush destination mask | implemented |
| `/tool mat` | — | Set the brush material | alias |
| `/tool material <pattern>` | — | Set the brush material | implemented |
